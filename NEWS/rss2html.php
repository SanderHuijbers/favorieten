...
$XMLfilename = "https://alarmeringen.nl/feeds/city/hoek-van-holland.rss";
...
$TEMPLATEfilename = "container.html";
...
@include("../../test/FeedForAll_rss2html_pro.php");
...
@include("../../test/FeedForAll_Scripts_CachingExtension.php");
